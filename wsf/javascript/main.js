...
<img src="./images/animate/4_1.png" alt="project">
</div>`;
let project_question_mark = `<div class="project_question_mark">
<img src="./images/animate/5_1.png" alt="question">
</div>`;
let project_text = `<div class="project_text">
<img src="./images/animate/6_1.png" alt="text">
</div>`;
let project_first_two_block = `<img src="./images/animate/7_1.png" alt="block" class="project_first_two_block">`;
let zero = `<img src="./images/animate/8.png" alt="zero" class="zero">`;
